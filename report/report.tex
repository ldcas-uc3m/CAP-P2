...
\shortauthor{
  ...
  \abbreviateauthor{Lucas}{Gallego Bravo},
  \abbreviateauthor{Francisco}{Montañés de Lucas} \&
  \abbreviateauthor{Diego}{Picazo García}
}

\lab{Práctica 2}
\title{Paralelización de código con MPI + OpenMP}
\shorttitle{Práctica 2}
\professor{Jesús Carretero}
